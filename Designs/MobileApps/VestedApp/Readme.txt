#UI screens for the PIN entry use case Vested app ~ Readme v1.0
...
Used figma to design the screens on MacOS 15.1

This was one of the use cases expected by the client, Vested a Mobile app for investing in the US stock market developed for both iOS and Android 
